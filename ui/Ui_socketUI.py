...
class Ui_SocketUi(object):
    def setupUi(self, SocketUi):
        ...
        self.sock_yingyan_web_btn.setGeometry(QtCore.QRect(30, 330, 75, 23))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Microsoft YaHei UI"))
        ...
        self.sock_pickPoint_btn.setGeometry(QtCore.QRect(30, 300, 75, 23))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Microsoft YaHei UI"))
    ...
    def retranslateUi(self, SocketUi):
        ...
        self.sock_send_btn.setText(_translate("SocketUi", "手动发送", None))
        self.sock_clear_btn.setText(_translate("SocketUi", "清除记录", None))
        self.sock_yingyan_web_btn.setText(_translate("SocketUi", "历史轨迹", None))
        ...
        self.sock_pickPoint_btn.setText(_translate("SocketUi", "轨迹设置", None))
