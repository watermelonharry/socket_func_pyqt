...
class Ui_yingyan_web(object):
    def setupUi(self, yingyan_web):
        ...
        self.web_recdata_label.setGeometry(QtCore.QRect(30, 140, 171, 12))
        ...
        self.web_longi_label.setGeometry(QtCore.QRect(80, 50, 100, 12))
        ...
        self.web_lati_label.setGeometry(QtCore.QRect(80, 80, 100, 12))
        ...
        self.web_altitu_label.setGeometry(QtCore.QRect(80, 110, 100, 12))
        ...
        self.web_time_label.raise_()
        self.web_const_time_label.raise_()
        self.web_recdata_label.raise_()
        self.label.raise_()
        self.label_2.raise_()
        self.label_3.raise_()
        self.webView.raise_()
        self.web_longi_label.raise_()
        self.web_lati_label.raise_()
        self.web_altitu_label.raise_()
        self.webView.raise_()
